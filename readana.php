...
$query3 = "";
			...
			select distinct  analysis_ref 
			 from micha_protocols p WHERE analysis_ref like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  analysis_metric 
			 from micha_protocols p WHERE analysis_metric like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  min_concentration 
			 from micha_protocols p WHERE min_concentration like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  max_concentration 
			 from micha_protocols p WHERE max_concentration like '" . strtoupper($_POST["keyword"]) . "%'  ";
