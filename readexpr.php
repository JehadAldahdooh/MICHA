...
$query3 = "";
			...
			select distinct  experimental_medium 
			 from micha_protocols p WHERE experimental_medium like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  plate_type 
			 from micha_protocols p WHERE plate_type like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  cell_density 
			 from micha_protocols p WHERE cell_density like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  dilution_fold 
			 from micha_protocols p WHERE dilution_fold like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  vehicle 
			 from micha_protocols p WHERE vehicle like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  method_dispensation 
			 from micha_protocols p WHERE method_dispensation like '" . strtoupper($_POST["keyword"]) . "%'  ";
			...
			select distinct  volume_per_well 
			 from micha_protocols p WHERE volume_per_well like '" . strtoupper($_POST["keyword"]) . "%'  ";
