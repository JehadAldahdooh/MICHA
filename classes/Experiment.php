...
class Experiment {	
	...
	public function updateRecord(){
		...
		if($this->id) {			
			...
			SET assay_name= ?, assay_format = ?, assay_test_type = ?, detection_technology = ?, endpoint_mode = ?,
			    medium= ?, plate_type = ?,  cell_density_at_plating = ?, time_of_treatment = ?,
			...
			$stmt->bind_param("sssssssssssssi", $this->assay_name, $this->assay_format, $this->assay_test_type,
                             			$this->detection_technology, $this->endpoint_mode, $this->medium,
										$this->plate_type,  $this->cell_density_at_plating,
	...
	public function addRecord(){
		...
		//if($this->assay_name) {
			...
			$stmt = $this->conn->prepare("INSERT INTO ".$this->recordsTable."(`session_id`,`file_name`,`assay_name`,`assay_format`,".
			"`assay_test_type`,`detection_technology`,`endpoint_mode`,`medium`,`plate_type`,".
		...
		echo $this->conn->error;
			...
			$stmt->bind_param("sssssssssssssss", $this->sid,$this->filename,$this->assay_name, $this->assay_format, $this->assay_test_type,
                            			$this->detection_technology, $this->endpoint_mode,$this->medium,
										$this->plate_type,$this->cell_density_at_plating,$this->time_of_treatment,
